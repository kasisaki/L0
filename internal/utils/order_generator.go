...
func GenerateRandomOrder(orderUID string) mod.Order {
...
func generateRandomDelivery() mod.Delivery {
	return mod.Delivery{
...
func generateRandomPayment() mod.Payment {
	return mod.Payment{
...
func generateRandomItems() []mod.Item {
	itemCount := rand.Intn(5) + 1
	items := make([]mod.Item, itemCount)
